    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl" data-testid="heading-login">Welcome Back</CardTitle>
          <CardDescription data-testid="text-description">Sign in to your MindFlow account</CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
